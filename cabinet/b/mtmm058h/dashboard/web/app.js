...
import { api, ApiError } from './api.js?v=mtmm058h';
import { h, badge, toast, sleep, usd } from './ui.js?v=mtmm058h';
import { apply as applyMotion, reduceMotion, setReduceMotion } from './motion.js?v=mtmm058h';
import { openTaskModal } from './components/task-form.js?v=mtmm058h';
import { openProjectWizard } from './components/project-wizard.js?v=mtmm058h';
import { AGENT_NAME } from './components/team-studio.js?v=mtmm058h';
import { render as today } from './screens/today.js?v=mtmm058h';
import { render as projectsScreen } from './screens/projects.js?v=mtmm058h';
import { render as content } from './screens/content.js?v=mtmm058h';
import { render as calendar } from './screens/calendar.js?v=mtmm058h';
import { render as approvals } from './screens/approvals.js?v=mtmm058h';
import { render as campaigns } from './screens/campaigns.js?v=mtmm058h';
import { render as tasks } from './screens/tasks.js?v=mtmm058h';
import { render as agents } from './screens/agents.js?v=mtmm058h';
import { render as analytics } from './screens/analytics.js?v=mtmm058h';
import { render as settings } from './screens/settings.js?v=mtmm058h';
import { render as seo } from './screens/seo.js?v=mtmm058h';
...
const app      = {
  ...
  render() {
    ...
    main.innerHTML = '';
    if (!app.state && screen !== 'projects') { main.appendChild(h('div', { class: 'empty' }, 'Загрузка состояния проекта…')); return; }
