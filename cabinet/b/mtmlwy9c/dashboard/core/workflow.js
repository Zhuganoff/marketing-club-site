...
import { computeContentHash, sha256 } from './hash.js?v=mtmlwy9c';
import { nextId, taskId as makeTaskId } from './ids.js?v=mtmlwy9c';
import { pushEvent } from './events.js?v=mtmlwy9c';
import { buildQualityReport } from './quality.js?v=mtmlwy9c';
import { getTask } from './approval.js?v=mtmlwy9c';
import { ctaFromProfile, seoProfileBrief } from './seo.js?v=mtmlwy9c';
